...
from .views import ProductListView, ProductDetailView, CustomerListView, CustomerDetailView, PaymentsListView, PaymentDetailView, OrderListView, OrderDetailView
