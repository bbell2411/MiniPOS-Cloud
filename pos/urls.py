...
from .views import ProductListView, ProductDetailView, CustomerListView, CustomerDetailView, PaymentsListView, PaymentDetailView, OrderListView, OrderDetailView, OrderItemsListView, PaymentIntentView, PaymentProcessView
...
urlpatterns=[
    ...
    path("orders/<int:order_id>/payment/<int:payment_intent_id>/",PaymentProcessView.as_view())
]